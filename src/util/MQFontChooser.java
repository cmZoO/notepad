...
public class MQFontChooser extends JDialog {  
    ...
    private void init(){  
        ...
        l1.setPreferredSize(new Dimension(330, 28));  
        l1.setMaximumSize(new Dimension(330, 28));  
        l1.setMinimumSize(new Dimension(330, 28));  
        l2.setPreferredSize(new Dimension(190, 28));  
        l2.setMaximumSize(new Dimension(190, 28));  
        l2.setMinimumSize(new Dimension(190, 28));  
        l3.setPreferredSize(new Dimension(160, 28));  
        l3.setMaximumSize(new Dimension(160, 28));  
        l3.setMinimumSize(new Dimension(160, 28));  
        box1.add(l1);  
        box1.add(l2);  
        box1.add(l3);  
        Box box2 = Box.createHorizontalBox();  
        fontText.setPreferredSize(new Dimension(320, 40));  
        fontText.setMaximumSize(new Dimension(320, 40));  
        fontText.setMinimumSize(new Dimension(320, 40));  
        box2.add(fontText);  
        box2.add(Box.createHorizontalStrut(5));  
        styleText.setPreferredSize(new Dimension(180, 40));  
        styleText.setMaximumSize(new Dimension(180, 40));  
        styleText.setMinimumSize(new Dimension(180, 40));  
        box2.add(styleText);  
        box2.add(Box.createHorizontalStrut(5));  
        sizeText.setPreferredSize(new Dimension(160, 40));  
        sizeText.setMaximumSize(new Dimension(160, 40));  
        sizeText.setMinimumSize(new Dimension(160, 40));  
        box2.add(sizeText);  
        Box box3 = Box.createHorizontalBox();  
        JScrollPane sp1 = new JScrollPane(fontList);  
        sp1.setPreferredSize(new Dimension(320, 200));  
        sp1.setMaximumSize(new Dimension(320, 200));  
        sp1.setMaximumSize(new Dimension(320, 200));  
        box3.add(sp1);  
        box3.add(Box.createHorizontalStrut(5));  
        JScrollPane sp2 = new JScrollPane(styleList);  
        sp2.setPreferredSize(new Dimension(180, 200));  
        sp2.setMaximumSize(new Dimension(180, 200));  
        sp2.setMinimumSize(new Dimension(180, 200));  
        box3.add(sp2);  
        box3.add(Box.createHorizontalStrut(5));  
        JScrollPane sp3 = new JScrollPane(sizeList);  
        sp3.setPreferredSize(new Dimension(160, 200));  
        sp3.setMaximumSize(new Dimension(160, 200));  
        sp3.setMinimumSize(new Dimension(160, 200));  
        box3.add(sp3);  
        ...
        box5.setPreferredSize(new Dimension(180, 190));  
        box5.setMaximumSize(new Dimension(180, 190));  
        box5.setMinimumSize(new Dimension(180, 190));  
        box6.add(previewText);  
        box6.setPreferredSize(new Dimension(500, 190));  
        box6.setMaximumSize(new Dimension(500, 190));  
        box6.setMinimumSize(new Dimension(500, 190));  
        box4.add(box5);  
